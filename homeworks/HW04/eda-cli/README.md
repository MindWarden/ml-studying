...
### `POST /quality-flags-from-csv` — **[+] Эндпоинт для HW03**

**Что делает**  
Принимает CSV-файл и возвращает **полный набор флагов качества данных**, включая все эвристики, реализованные в HW03  
(константные колонки, высокая кардинальность категориальных признаков, дубликаты ID-подобных колонок и т.д.).

**Зачем нужен**  
Демонстрирует использование доработок из HW03 в HTTP-API (требование 2.3.2).
